...
**Aside:** Ooo, that `SEO` component config in the [Add Page Metadata](https://www.gatsbyjs.org/tutorial/part-eight/#add-page-metadata) section looks really nice. I had to learn how to adjust settings for `title` prop and `description` prop to fit my needs.
